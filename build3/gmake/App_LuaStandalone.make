...
ifeq ($(config),release32)
  ...
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/App_LuaStandalone_gmake
  DEFINES   += 
...
ifeq ($(config),debug32)
  ...
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/App_LuaStandalone_gmake_debug
  DEFINES   += -D_DEBUG=1
  INCLUDES  += -I../../btgui/lua-5.2.3/src
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),release64)
  ...
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/App_LuaStandalone_gmake_x64_release
  DEFINES   += 
  INCLUDES  += -I../../btgui/lua-5.2.3/src
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),debug64)
  ...
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/App_LuaStandalone_gmake_x64_debug
  DEFINES   += -D_DEBUG=1
  INCLUDES  += -I../../btgui/lua-5.2.3/src
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
