...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/test_bullet_collision
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/test_bullet_collision_gmake
  DEFINES   += 
  ...
  LIBS      += ../../bin/libLinearMath_gmake.a ../../bin/libgtest_gmake.a
  LDDEPS    += ../../bin/libLinearMath_gmake.a ../../bin/libgtest_gmake.a
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/test_bullet_collision
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/test_bullet_collision_gmake_debug
  DEFINES   += -D_DEBUG=1
  INCLUDES  += -I../../test/collision -I../../src -I../../test/gtest-1.7.0/include
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
  ...
  LDFLAGS   += -L../../bin -m32 -L/usr/lib32
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
  LIBS      += ../../bin/libLinearMath_gmake_debug.a ../../bin/libgtest_gmake_debug.a
  LDDEPS    += ../../bin/libLinearMath_gmake_debug.a ../../bin/libgtest_gmake_debug.a
  LINKCMD    = $(CXX) -o $(TARGET) $(OBJECTS) $(RESOURCES) $(ARCH) $(LIBS) $(LDFLAGS)
  define PREBUILDCMDS
  endef
  define PRELINKCMDS
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/Release/test_bullet_collision
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/test_bullet_collision_gmake_x64_release
  DEFINES   += 
  INCLUDES  += -I../../test/collision -I../../src -I../../test/gtest-1.7.0/include
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/Debug/test_bullet_collision
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/test_bullet_collision_gmake_x64_debug
  DEFINES   += -D_DEBUG=1
  INCLUDES  += -I../../test/collision -I../../src -I../../test/gtest-1.7.0/include
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking test_bullet_collision
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning test_bullet_collision
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
