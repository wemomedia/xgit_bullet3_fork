...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/Test_OpenCL_Primitives_clew
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/Test_OpenCL_Primitives_clew_gmake
  DEFINES   += -DB3_USE_CLEW
  INCLUDES  += -I../../src/clew -I../../test/OpenCL/ParallelPrimitives -I../../src
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/Test_OpenCL_Primitives_clew
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/Test_OpenCL_Primitives_clew_gmake_debug
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/Release/Test_OpenCL_Primitives_clew
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/Test_OpenCL_Primitives_clew_gmake_x64_release
  DEFINES   += -DB3_USE_CLEW
  INCLUDES  += -I../../src/clew -I../../test/OpenCL/ParallelPrimitives -I../../src
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/Debug/Test_OpenCL_Primitives_clew
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/Test_OpenCL_Primitives_clew_gmake_x64_debug
  DEFINES   += -D_DEBUG=1 -DB3_USE_CLEW
  INCLUDES  += -I../../src/clew -I../../test/OpenCL/ParallelPrimitives -I../../src
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking Test_OpenCL_Primitives_clew
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning Test_OpenCL_Primitives_clew
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/main.o: ../../test/OpenCL/ParallelPrimitives/main.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
