...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/Bullet3Common
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/libBullet3Common_gmake.a
  DEFINES   += 
  INCLUDES  += -I../../src
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/Bullet3Common
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/libBullet3Common_gmake_debug.a
  DEFINES   += -D_DEBUG=1
  INCLUDES  += -I../../src
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
